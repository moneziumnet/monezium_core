...
Route::get('/access/paypal/success/{shop_id}', [AccessController::class, 'notify'])->name('api.pay.paypal.success');
Route::get('/access/paypal/cancel/{shop_id}', [AccessController::class, 'cancel'])->name('api.pay.paypal.cancel');
