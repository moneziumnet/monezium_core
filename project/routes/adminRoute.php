...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:Staff Management'], function () {
      ...
      Route::POST('/user/bank/openpayduk',[OpenPaydController::class,'store_uk'])->name('admin.user.bank.openpayduk');
      Route::POST('/user/bank/tribepayment',[TribePaymentController::class,'store'])->name('admin.user.bank.tribepayment');
    ...
    Route::group(['middleware' => 'permissions:Report'], function () {
      ...
      Route::get('/bank/report/transaction/fee/{id}', [ReportTransactionController::class,'feeDetails'])->name('admin.report.transaction.fee.detail');
      Route::get('/bank/report/transaction/total/fee', [ReportTransactionController::class,'totalfeeDetails'])->name('admin.report.transaction.total.fee.detail');
    ...
    Route::post('/system-settings/withdraw/store', [SystemAccountController::class, 'withdraw_store'])->name('admin.system.account.withdraw.store');
