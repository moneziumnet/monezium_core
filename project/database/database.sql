...
INSERT INTO `email_templates` VALUES (16, 'request_money_complete', 'Money request is complete.', '<p>Hello {name},<br>Request money is completed successfully.</p><p>Money {curr} {amount} is sent from {from} to {to} at {date_time}.</p><p><span style="font-size: 1rem;">Your charge Fee is {curr} {charge}.</span></p><p><span style="font-size: 1rem;">Transaction id is [trnx].</span></p><p><span style="font-size: 1rem;">Thank You</span><br></p>', 1);
