...
INSERT INTO `email_templates` VALUES (36, 'wallet_create', 'Your wallet is created successfully.', '<p>Hello {name},</p><p>Your {type} {curr} wallet is created successfully at {date_time}.<br><span style="font-size: 1rem;">Wallet Create fee is {amount}{curr}.<br></span><span style="font-size: 1rem;">Transaction id is {trnx}.&nbsp; &nbsp;</span></p><p><span style="font-size: 1rem;">Thank You.</span><br></p>', 1);
