...
INSERT INTO `email_templates` VALUES (3, 'send_money', 'Money send successfully.', '<p>Hello {name},<br>Your send money is completed successfully.</p><p>Money {curr} {amount} is sent from {from} to {to} at {date_time}.</p><p><span style="font-size: 1rem;">Your charge Fee is {curr} {charge}.</span></p><p><span style="font-size: 1rem;">Transaction id is [trnx].</span></p><p><span style="font-size: 1rem;">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (4, 'request_money_sent', 'Money request is received.', '<p>Hello {name},<br>You are received money request from {from}.</p><p>Amount {curr} {amount} will be sent from {to} to {from}.</p><p><span style="font-size: 1rem;">Your charge Fee is {curr} {charge}.<br></span><span style="font-size: 1rem;">Request time is {date_time}.</span></p><p><span style="font-size: 1rem;">Thank You</span><span style="font-size: 1rem;"><br></span></p>', 1);
...
INSERT INTO `email_templates` VALUES (16, 'online_selfie_link', 'Online Selfie Link', '<p>Hello {name},<br><span style="font-size: 1rem;">This is the link of online Selfie for&nbsp; you.</span></p><p><span style="font-size: 1rem;">Please click this <a href="{url}" target="_blank">url</a>.</span></p><p><span style="font-size: 1rem;">Thank You</span><br></p>', 1);
...
INSERT INTO `email_templates` VALUES (19, 'wallet_create', 'Your wallet is created successfully.', '<p>Hello {name},<br>Your {type} {curr} wallet is created successfully at {date_time}.<br><span style="font-size: 1rem;">Wallet Create fee is {amount}{curr}.<br></span><span style="font-size: 1rem;">Transaction id is {trnx}.&nbsp; &nbsp;</span></p><p><span style="font-size: 1rem;">Thank You.</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (20, 'account_maintenance', 'Account maintenance', '<p>Hello {name},<br>Your {type} {curr} wallet is maintenanced successfully at {date_time}.<br><span style="font-size: 1rem;">Wallet&nbsp;</span>maintenance&nbsp;<span style="font-size: 1rem;">fee is {amount}{curr}.<br></span><span style="font-size: 1rem;">Transaction id is {trnx}.&nbsp; &nbsp;</span></p><p><span style="font-size: 1rem;">Thank You.</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (21, 'loan_request', 'You have sent Loan request.', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">You have sent Loan request successfully.</span></p><p>Request Loan Amount is {curr} {amount}.</p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (22, 'loan_approved', 'Your Loan have been approved', '<p>Hello {name},<br></p><p>Your Loan have been approved successfully.</p><p>Thank You<br></p>', 1);
INSERT INTO `email_templates` VALUES (23, 'loan_reject', 'Your Loan have been rejected', '<p>Hello {name},<br></p><p>Your Loan have been rejected.</p><p>Please send Loan request again.</p><p>Thank You<br></p>', 1);
INSERT INTO `email_templates` VALUES (24, 'loan_finish', 'Your Loan have been finished', '<p>Hello {name},<br></p><p>Your Loan have been finished.</p><p><span style=\"font-size: 1rem;\">You can send Loan request again.</span></p><p>Thank You<br></p>', 1);
INSERT INTO `email_templates` VALUES (25, 'fdr_run', 'New FDR run successfully.', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">New FDR run successfully.</span></p><p>New Running FDR Amount is {curr} {amount}.</p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (26, 'fdr_finish', 'Your FDR have been finished', '<p>Hello {name},<br></p><p>Your FDR have been finished.</p><p>You can send FDR request again.</p><p>Thank You<br></p>', 1);
INSERT INTO `email_templates` VALUES (27, 'dps_run', 'New DPS run successfully.', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">New DPS run successfully.</span></p><p>New Running DPS Amount is {curr} {amount}.</p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (28, 'dps_finish', 'Your DPS have been finished', '<p>Hello {name},<br></p><p>Your DPS have been finished.</p><p>You can send DPS request again.</p><p>Thank You<br></p>', 1);
INSERT INTO `email_templates` VALUES (29, 'merchant_shop_request', 'New Shop', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">you have requested New Shop approved.</span></p><p><span style=\"font-size: 1rem;\">Shop Name is {shop_name}.</span></p><p><span style=\"font-size: 1rem;\">Shop online url is&nbsp;<a href=\"{url}\" target=\"_blank\">url</a>.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (30, 'merchant_shop_approved', 'New Shop Approved', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your New Shop is approved.</span></p><p><span style=\"font-size: 1rem;\">Shop Name is {shop_name}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (31, 'merchant_product_created', 'New Product Created', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your New Product is created.</span></p><p><span style=\"font-size: 1rem;\">Product Name is {product_name}.</span></p><p><span style=\"font-size: 1rem;\">Product Price is {amount} {curr}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (32, 'campaign_created', 'New Campaign Created', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">You have requested New Campaign approved.</span></p><p><span style=\"font-size: 1rem;\">New Campaign Title is {campaign_title}.</span></p><p><span style=\"font-size: 1rem;\">The final Goal amount is {amount} {curr}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (33, 'campaign_enable', 'New Campaign is Enabled', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your New Campaign is approved.</span></p><p><span style=\"font-size: 1rem;\">New Campaign Title is {campaign_title}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (34, 'campaign_disable', 'Campaign is Disabled', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your Campaign is disabled.</span></p><p><span style=\"font-size: 1rem;\">Campaign Title is {campaign_title}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (35, 'donate', 'New Donate', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">{user_name} donate to your campaign successfully.</span></p><p><span style=\"font-size: 1rem;\">Campaign Title is {campaign_title}.</span></p><p>Donate Amount is {curr} {amount}.</p><p><span style=\"font-size: 1rem;\">Donate Time is {date_time}.</span><br></p><p>Thank You<br></p>', 1);
INSERT INTO `email_templates` VALUES (36, 'escrow_release', 'Escrow Release', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">{user_name} release Escrow for you successfully.</span></p><p><span style=\"font-size: 1rem;\">The Escrow Amount is {amount}{curr}.</span></p><p><span style=\"font-size: 1rem;\">Escrow Fee is {charge}{curr}</span></p><p>Release Transaction ID is {trnx}.</p><p><span style=\"font-size: 1rem;\">Release Time is {date_time}.</span><br></p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (37, 'escrow_dispute', 'Escrow Dispute', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">Dispute about Escrow has been created by {user_name}.</span></p><p><span style=\"font-size: 1rem;\">Reason is {reason}</span><br></p><p>Escrow Transaction ID is {trnx}.</p><p><span style=\"font-size: 1rem;\">Dispute Request Time is {date_time}.</span><br></p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (38, 'voucher_create', 'New Voucher Create', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">You have created New Voucher successfully.</span></p><p><span style=\"font-size: 1rem;\">New Voucher Amount is {amount}{curr}.</span></p><p><span style=\"font-size: 1rem;\">Voucher Transaction ID is {trnx}.</span><br></p><p><span style=\"font-size: 1rem;\">Voucher Create Time is {date_time}.</span><br></p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (39, 'voucher_reedem', 'Voucher Reedemed', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">New Voucher have been redeemed successfully.</span></p><p><span style=\"font-size: 1rem;\">New Voucher Amount is {amount}{curr}.</span></p><p><span style=\"font-size: 1rem;\">Voucher Transaction ID is {trnx}.</span><br></p><p><span style=\"font-size: 1rem;\">Voucher Redeem Time is {date_time}.</span><br></p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (40, 'ico_create', 'New ICO', '<p>Hello {name},<br></p><p><span style=\"font-size: 1rem;\">You have created new ICO token successfully.</span></p><p><span style=\"font-size: 1rem;\">New ICO token price is {amount}.</span></p><p><span style=\"font-size: 1rem;\">Total supply is {total_supply}.</span></p><p><span style=\"font-size: 1rem;\">Symbol is {symbol}.</span></p><p><span style=\"font-size: 1rem;\">ICO Token Code is {code}.</span></p><p><span style=\"font-size: 1rem;\">ICO token create time is {date_time}.</span><br></p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (41, 'profile_update', 'Profile Update', '<p>Hello {name},<br></p><p>Your profile is updated successfully.</p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (42, 'plan_upgrade', 'Plan Upgrade', '<p>Hello {name},<br></p><p>Your plan is updated successfully.</p><p>Plan Price is {curr}{amount}.</p><p>Plan updated time is {date_time}.</p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (43, 'ticket_create', 'New Ticket Create', '<p>Hello {name},<br></p><p>You have created new Ticket successfully.</p><p>Ticket Title is {title}.</p><p>Ticket Create time is {date_time}.</p><p>Thank You.<br></p>', 1);
INSERT INTO `email_templates` VALUES (44, 'ticket_reply', 'Ticket Reply', '<p>Hello {name},<br></p><p>New Ticket reply is received.</p><p>Ticket Title is {title}.</p><p>Ticket Reply time is {date_time}.</p><p>Thank You.<br></p>', 1);
