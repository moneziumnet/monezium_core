...
INSERT INTO `email_templates` VALUES (5, 'request_money_complete', 'Money request is complete.', '<p>Hello {name},<br>Request money is completed successfully.</p><p>Money {curr} {amount} is sent from {from} to {to} at {date_time}.</p><p><span style="font-size: 1rem;">Your charge Fee is {curr} {charge}.</span></p><p><span style="font-size: 1rem;">Transaction id is [trnx].</span></p><p><span style="font-size: 1rem;">Thank You</span><br></p>', 1);
...
INSERT INTO `email_templates` VALUES (21, 'merchant_shop_request', 'New Shop', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">you have requested New Shop approved.</span></p><p><span style=\"font-size: 1rem;\">Shop Name is {shop_name}.</span></p><p><span style=\"font-size: 1rem;\">Shop online url is&nbsp;<a href=\"{url}\" target=\"_blank\">url</a>.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (22, 'merchant_shop_approved', 'New Shop Approved', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your New Shop is approved.</span></p><p><span style=\"font-size: 1rem;\">Shop Name is {shop_name}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (23, 'merchant_product_created', 'New Product Created', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your New Product is created.</span></p><p><span style=\"font-size: 1rem;\">Product Name is {product_name}.</span></p><p><span style=\"font-size: 1rem;\">Product Price is {amount} {curr}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
...
INSERT INTO `email_templates` VALUES (26, 'campaign_enable', 'New Campaign is Enabled', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your New Campaign is approved.</span></p><p><span style=\"font-size: 1rem;\">New Campaign Title is {campaign_title}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (27, 'campaign_disable', 'Campaign is Disabled', '<p>Hello {name},<br><span style=\"font-size: 1rem;\">Your Campaign is disabled.</span></p><p><span style=\"font-size: 1rem;\">Campaign Title is {campaign_title}.</span></p><p><span style=\"font-size: 1rem;\">Thank You</span><br></p>', 1);
...
INSERT INTO `email_templates` VALUES (36, 'wallet_create', 'Your wallet is created successfully.', '<p>Hello {name},<br>Your {type} {curr} wallet is created successfully at {date_time}.<br><span style="font-size: 1rem;">Wallet Create fee is {amount}{curr}.<br></span><span style="font-size: 1rem;">Transaction id is {trnx}.&nbsp; &nbsp;</span></p><p><span style="font-size: 1rem;">Thank You.</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (37, 'account_maintenance', 'Account maintenance', '<p>Hello {name},<br>Your {type} {curr} wallet is maintenanced successfully at {date_time}.<br><span style="font-size: 1rem;">Wallet&nbsp;</span>maintenance&nbsp;<span style="font-size: 1rem;">fee is {amount}{curr}.<br></span><span style="font-size: 1rem;">Transaction id is {trnx}.&nbsp; &nbsp;</span></p><p><span style="font-size: 1rem;">Thank You.</span><br></p>', 1);
INSERT INTO `email_templates` VALUES (38, 'online_selfie_link', 'Online Selfie Link', '<p>Hello {name},<br><span style="font-size: 1rem;">This is the link of online Selfie for&nbsp; you.</span></p><p><span style="font-size: 1rem;">Please click this <a href="{url}" target="_blank">url</a>.</span></p><p><span style="font-size: 1rem;">Thank You</span><br></p>', 1);
...
INSERT INTO `email_templates` VALUES (44, 'verify_code', 'You received verify code.', '<p>Hello {name},<br>You received verify code.</p><p>Verify Code is {code}.<br>Please check code.</p><p>Thank you.</p><p><br></p>', 1);
