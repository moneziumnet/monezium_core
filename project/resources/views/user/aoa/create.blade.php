                    ...
                    <form id="aoa-form" action="{{ route('user.contract.aoa.store', $id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <select class="form-select shadow-none" id="client" name="client" required>
                                        ...
                                        @endphp
                                        <option type="beneficiary" data="{{json_encode($client_item)}}" value="{{$user->id}}" >{{$user->company_name ?? $user->name}}</option>
                                        @endforeach
                                        @php
                                        $client_item = App\Models\User::select('name','email','address','phone')
                                            ->find(auth()->id());
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3 mt-3">
                                    ...
                                    <input name="title" id="title" class="form-control" autocomplete="off" placeholder="{{__('Enter Title')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3 mt-3">
                        ...
                        <div class="row form-group mb-3 mt-3">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="desc_title[]" class="form-control shadow-none itemname">
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center py-4">
                                    ...
                                    <div class="row form-group mt-3 text-start">
                                        <div class="col-md-4"><div class="form-label">{{__('Pattern name')}}</div></div>
                                        <div class="col-md-8"><div class="form-label">{{__('Value')}}</div></div>
                                    </div>
                                    ...
                                    <div class="row form-group mb-3 mt-3">
                                        <div class="col-md-4 mb-3">
                                            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="item[]" class="form-control shadow-none itemname"  >
                                        </div>
                                        <div class="col-md-7 mb-3">
                                            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="value[]" class="form-control shadow-none itemvalue"  >
                                        </div>
                                        <div class="col-md-1 mb-3">
                    ...
                    <form action="{{route('user.contract.beneficiary.create')}}" method="post" enctype="multipart/form-data" id="iban-submit">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mt-3 col-md-6">
                                ...
                                <input name="address" id="address" class="form-control shadow-none" placeholder="{{__('Address')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('address') }}" required>
                            </div>
                            <div class="form-group mt-3 col-md-6">
                            ...
                            <div class="form-group mt-3 col-md-6">
                                ...
                                <input name="registration_no" id="registration_no" class="form-control shadow-none" placeholder="{{__('Registration NO')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('registration_no') }}" required>
                            </div>
                            <div class="form-group mt-3 col-md-6">
                                <label class="form-label required">{{__('VAT NO')}}</label>
                                <input name="vat_no" id="vat_no" class="form-control shadow-none" placeholder="{{__('VAT NO')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('vat_no') }}" required>
                            </div>
                            <div class="form-group mt-3 col-md-6">
                                <label class="form-label required">{{__('Contact Person')}}</label>
                                <input name="contact_person" id="contact_person" class="form-control shadow-none" placeholder="{{__('Contact Person')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('contact_person') }}" required>
                            </div>
                            <hr class="my-3"/>
                            <div class="form-group mt-3 col-md-6">
                            ...
                            <div class="form-group mt-3 col-md-6">
                                ...
                                <input name="bank_address" id="bank_address" class="form-control" autocomplete="off" placeholder="{{__('Enter Bank Address')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('bank_address') }}" min="1" required readonly>
                            </div>
                            <div class="form-group mt-3 col-md-6">
                                <label class="form-label required">{{__('SWIFT/BIC')}}</label>
                                <input name="swift_bic" id="swift_bic" class="form-control" autocomplete="off" placeholder="{{__('MEINATWW')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('swift_bic') }}" min="1" required readonly>
                            </div>
                        </div>
...
var setDefaultDiv = function(div_name, keys, values){
    ...
    for (let index = 0; index < keys.length; index++) {
        ...
        <div class="row form-group mb-3 mt-3">
            <div class="col-md-4 mb-3">
                <input type="text" pattern="[^À-ž()/><\\][\\\\;&$@!|]+" name="default_item[]" class="form-control shadow-none itemname" value="${keys[index]}" readonly>
            </div>
            <div class="col-md-8 mb-3">
                <input type="text" pattern="[^À-ž()/><\\][\\\\;&$@!|]+" name="default_value[]" class="form-control shadow-none itemvalue" value="${values[index]}" readonly >
            </div>
        </div>
        `;
...
$('.add').on('click',function(){
    $('.extra-container').append(`
        <div class="row form-group mb-3 mt-3">
            <div class="col-md-4 mb-3">
                <input type="text" pattern="[^À-ž()/><\\][\\\\;&$@!|]+" name="item[]" class="form-control shadow-none itemname" required>
            </div>
            <div class="col-md-7 mb-3">
                <input type="text" pattern="[^À-ž()/><\\][\\\\;&$@!|]+" name="value[]" class="form-control shadow-none itemvalue" required>
            </div>
            <div class="col-md-1 mb-3">
