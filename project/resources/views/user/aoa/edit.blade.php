                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3 mt-3">
                                    ...
                                    <input name="title" id="title" class="form-control" autocomplete="off" placeholder="{{__('Enter Title')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{$data->title}}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3 mt-3">
                        ...
                        @foreach ($information as $key => $value)
                            ...
                            <div class="row form-group mb-3 mt-3">
                                <div class="col-md-4 mb-3">
                                    ...
                                    @endif
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="desc_title[]" class="form-control shadow-none itemname" value="{{$key}}" >
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center py-4">
                                    ...
                                    @foreach (json_decode($data->pattern, True) as $key => $value)
                                        <div class="row form-group mb-3 mt-3">
                                            <div class="col-md-4 mb-3">
                                                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="item[]" class="form-control shadow-none itemname" value="{{$key}}" >
                                            </div>
                                            <div class="col-md-7 mb-3">
                                                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="value[]" class="form-control shadow-none itemvalue" value="{{$value}}" >
                                            </div>
                                            @if ($loop->first)
                                                <div class="col-md-1 mb-3">
