                ...
                <div class="card p-5">
                    <form id="shop-form" action="{{ route('user.merchant.shop.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <input name="name" id="name" class="form-control" autocomplete="off" placeholder="{{__('Please Input Shop Name')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{$data->name}}" required>
                        </div>
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <input name="url" id="url" class="form-control" autocomplete="off" placeholder="{{__('https://example.com')}}" type="url" value="{{$data->url}}" required>
                        </div>

                        <div class="form-group mb-3 mt-3">
                            <label class="form-label">{{__('Shop Webhook URL')}}</label>
                            <input name="webhook" id="webhook" class="form-control" autocomplete="off" placeholder="{{__('https://example.com')}}" type="url" value="{{$data->webhook}}" >
                        </div>
