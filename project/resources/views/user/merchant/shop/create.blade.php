      ...
      <div class="row align-items-center">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
              ...
              <a href="{{ route('user.merchant.shop.index') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="card p-5">
                    <form id="shop-form" action="{{ route('user.merchant.shop.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <input name="name" id="name" class="form-control" autocomplete="off" placeholder="{{__('Please Input Your Name')}}" type="text" required>
                        </div>
