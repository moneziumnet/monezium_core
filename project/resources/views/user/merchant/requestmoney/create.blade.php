                ...
                <div class="card p-5">
                    ...
                    <form id="request-form" action="{{ route('user.merchant.money.request.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3 mt-3">
                            ...
                            <input name="account_name" id="account_name" class="form-control" autocomplete="off" placeholder="{{__('Jhon Doe')}}" type="text" pattern="[^À-ž()/><\][\\\-;&$@!|]+" value="{{ old('account_name') }}" min="1" required readonly>
                        </div>
