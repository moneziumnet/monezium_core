                        ...
                        <form id="shop-form" action="{{ route('user.ico.update', $item->id) }}" method="POST"
                            ...
                            <div class="form-group mt-2 mb-3">
                                ...
                                <input name="name" id="name" class="form-control shadow-none"
                                    placeholder="{{ __('Name') }}" type="text" pattern="[^À-ž()/><\][\\\-;&$@!|]+" value="{{ $item->name }}" required>
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label">{{ __('Code') }}</label>
                                <input name="code" id="code" class="form-control shadow-none"
                                    placeholder="{{ __('Code') }}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ $item->currency->code }}" required>
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label">{{ __('Symbol') }}</label>
                                <input name="symbol" id="symbol" class="form-control shadow-none"
                                    placeholder="{{ __('Symbol') }}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input name="address" id="address" class="form-control shadow-none"
                                    placeholder="{{ __('Address') }}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+"
