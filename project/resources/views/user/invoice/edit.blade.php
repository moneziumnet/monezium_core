                  ...
                  @csrf
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-3">
                            ...
                            @endif
                            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="item[]" class="form-control shadow-none itemname" required value="{{$value->name}}">
                        </div>
                    ...
                    <form action="" method="post" id="customerSubmit" enctype="multipart/form-data">
                        ...
                        <div class = "row">
                            <div class="form-group mt-2">
                                ...
                                <input name="name" id="name" class="form-control shadow-none" placeholder="{{__('Tax Name')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ old('name') }}" required>
                            </div>
                            <div class="form-group mt-2">
