                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="firstname" class="form-control form--control" autocomplete="off" placeholder="{{__('User First Name')}}" type="text" pattern="[^À-ž()/><\][\\\-;&$@!|]+" value="{{ explode(" ", $user->name)[0] ?? $user->name }}" required readonly>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="lastname" class="form-control form--control" autocomplete="off" placeholder="{{__('User Last Name')}}" type="text" pattern="[^À-ž()/><\][\\\-;&$@!|]+" value="{{ explode(" ",$user->name)[1] ?? ""}}" required readonly>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input name="address" class="form-control form--control" autocomplete="off" placeholder="{{__('Address')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ $user->address }}" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="form-label required">{{__('Zip Code')}}</label>
                              <input name="zip" class="form-control form--control" autocomplete="off" placeholder="{{__('Zip')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ $user->zip }}" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="form-label required">{{__('City')}}</label>
                              <input name="city" class="form-control form--control" autocomplete="off" placeholder="{{__('City')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ $user->city }}" required>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @endphp
                                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control form--control" value="{{ $country ? $country->name : '' }}" readonly>
                            </div>
                          </div>
                          @php
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="private-input form-control form--control" id="personal_code" name="personal_code" placeholder="{{ __('Enter Personal Code/Number') }}" value="{{$user->personal_code}}" {{$private_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label for="your-id" class="form-label">{{ __('Your ID Number') }}</label>
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="private-input form-control form--control" id="your_id" name="your_id" placeholder="{{ __('Enter Your ID Number') }}" value="{{$user->your_id}}" {{$private_required}}>
                                </div>
                              </div>
                              <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label for="your-id" class="form-label">{{ __('Provider Authority Name') }}</label>
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="private-input form-control form--control" id="issued_authority" name="issued_authority" placeholder="{{ __('Enter Provider Authority Name') }}" value="{{$user->issued_authority}}" {{$private_required}}>
                                </div>
                              </div>
                              <div class="col-md-6 mt-3">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" id="company_name"name="company_name" placeholder="{{ __('Enter Company Name') }}" value="{{ $user->company_name }}" {{$corporate_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-2">
                              ...
                              <div class="col-md-6">
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" id="company_address"name="company_address" placeholder="{{ __('Enter Company Address') }}" value="{{ $user->company_address }}" {{$corporate_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-2">
                                    <label for="dob" class="form-label">{{ __('Company City') }}</label>
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" id="company_city"name="company_city" placeholder="{{ __('Enter Company City') }}" value="{{ $user->company_city }}" {{$corporate_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label for="dob" class="form-label">{{ __('Company ZipCode') }}</label>
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" id="company_zipcode"name="company_zipcode" placeholder="{{ __('Enter Company ZipCode') }}" value="{{ $user->company_zipcode }}" {{$corporate_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-3">
                                    ...
                                    @endphp
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" value="{{ $country ? $country->name : '' }}" readonly>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label for="dob" class="form-label">{{ __('Registration No') }}</label>
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" id="company_reg_no"name="company_reg_no" placeholder="{{ __('Enter Company Registration No') }}" value="{{ $user->company_reg_no }}" {{$corporate_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-3">
                                    <label for="dob" class="form-label">{{ __('VAT No') }}</label>
                                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="company-input form-control form--control" id="company_vat_no"name="company_vat_no" placeholder="{{ __('Enter Company VAT No') }}" value="{{ $user->company_vat_no }}" {{$corporate_required}}>
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group mt-3">
