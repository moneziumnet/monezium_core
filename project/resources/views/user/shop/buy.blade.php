              ...
              <div class="col-md-5 text-end ">
                <form action="{{route('user.merchant.product.pay')}}" id="form_submit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ms-5 mt-4" id="crypto_pay" style="display: none;">
                        ...
                        <div>
                            <button id="submit" name="link_pay_submit" value="{{$currency->id}}" class="btn btn-primary w-100 btn-block mb-2"> {{__('Pay with ')}}{{$currency->curr_name}} - {{$currency->code}}</button>
                        </div>
                        @endforeach
                    </div>
                </form>
