                      ...
                      <div class="col-sm-6 col-md-6 mb-3">
                          ...
                          <div class="card-body">
                              <div class="row">
                                ...
                                <a class="col-auto btn-icon-clipboard copy tx-color" data-clipboard-text="{{$item->wallet_no}}" title="Copy"><i class="fa fa-copy text-xs"></i></a>
                              </div>
              ...
              <div class="card-header">
                ...
                <div class="card-actions">
                  <a href="{{route('user.transaction')}}" >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right tx-color" viewBox="0 0 16 16">
