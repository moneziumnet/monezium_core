                        ...
                        <form action="{{route('user.beneficiaries.update', $beneficiary->id)}}" method="POST" enctype="multipart/form-data" id="iban-submit">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3 mt-3 col-md-6">
                                    ...
                                    <input name="swift_bic" id="swift_bic" class="form-control" autocomplete="off" placeholder="{{__('MEINATWW')}}" type="text" pattern="[^()/><\][\\;!|]+" value="{{ $beneficiary->swift_bic  }}" min="1" required readonly>
                                </div>
