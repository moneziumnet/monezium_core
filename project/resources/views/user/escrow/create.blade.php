                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="email" name="receiver" id="receiver" class="form-control shadow-none receiver camera_value" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select wallet shadow-none" name="wallet_id">
                                ...
                                @foreach ($wallets as $wallet)
                                  <option value="{{$wallet->id}}" data-rate="{{getRate($wallet->currency)}}" data-code="{{$wallet->currency->code}}" data-type="{{$wallet->currency->type}}">{{$wallet->currency->code}} -- ({{amount($wallet->balance,$wallet->currency->type,2)}})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="form-label ">@lang('Amount : ') </div>
                            <input type="number" step="any" name="amount" id="amount" class="form-control shadow-none mb-2" disabled required>
