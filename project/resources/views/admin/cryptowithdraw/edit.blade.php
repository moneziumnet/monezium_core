        ...
        <div class="card-body">
            ...
            <form class="geniusform" action="{{route('admin.withdraws.crypto.update', $withdraw->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="sender_address" name="sender_address" value="{{ $withdraw->sender_address}}" readonly required>
              </div>

              <div class="form-group">
                <label for="amount">{{ __('Amount') }}</label>
                <input type="text" class="form-control" id="amount" name="amount"  value="{{ $withdraw->amount.$withdraw->currency->code}}" readonly required>
              </div>

              <div class="form-group">
                <label for="hash">{{ __('Hash') }}</label>
                <input type="text" class="form-control" id="hash" name="hash" placeholder="{{ __('Enter Hash Value') }}" value="{{$withdraw->hash}}" required>
              </div>
