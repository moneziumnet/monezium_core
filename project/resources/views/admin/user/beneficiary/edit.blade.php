                                        ...
                                        <form action="{{route('admin-user-beneficiary-update', $beneficiary->id)}}" method="POST" enctype="multipart/form-data" id="iban-submit">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group mt-2 col-md-6">
                                                    ...
                                                    <input name="swift_bic" id="swift" class="form-control" autocomplete="off" placeholder="{{__('MEINATWW')}}" type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" value="{{ $beneficiary->swift_bic  }}"  required readonly>
                                                </div>
                                            </div>
