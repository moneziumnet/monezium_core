        ...
        <div class="card-body">
            <div class="card mb-1">
                <div class="container-xl align-items-center justify-content-between py-3">
                  <h5 class=" mb-0 text-gray-800 pl-3">{{__('Beneficiary Edit')}}</h5>
                </div>
            </div>
            <div class="card mb-4">
                            ...
                            <div class="col-12">
                                <div class="card p-5">
                                    <div class="gocover" style="background: url({{ asset('assets/images/'.$gs->loader) }}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                                        ...
                                        <form action="{{route('admin-user-beneficiary-update', $beneficiary->id)}}" method="POST" enctype="multipart/form-data" id="iban-submit">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group mt-2 col-md-6">
                                                    ...
                                                    <input name="bank_address" id="bank_address" class="form-control" autocomplete="off" placeholder="{{__('Enter Bank Address')}}" type="text" pattern="[^()/><\][\\;&$@!|]+" value="{{  $beneficiary->bank_address }}" required readonly>
                                                </div>
