...
@section('content')
    ...
    <div class="card">
        ...
        <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Customer List') }}</h5>
                            ...
                            <div class="col-md-12">
                                <div class="contact-form">
                                    <form id="emailreply1">
                                        ...
                                        <div class="form-group">
                                            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="subj1" name="subject"  placeholder="{{ __('Subject') }}" value="" required="">
                                        </div>
