...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between py-3">
    @php
        $accounttype = array('0'=>'All', '1'=>'Current', '2'=>'Card', '3'=>'Deposit', '4'=>'Loan', '5'=>'Escrow', '6'=>'Supervisor', '7'=>'Merchant', '8'=>'Crypto', '9'=>'System', '10'=>'Manager');
...
<script type="text/javascript">
    ...
    var table = $('#geniustable').DataTable({
           ...
           serverSide: true,
           searching: true,
           ajax: "{{ route('admin-wallet.transactions-datatables',$wallet->id) }}",
           columns: [
