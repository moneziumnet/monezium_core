    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{ route('admin.gs.update') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="input-field" placeholder="{{ __('Mail Username') }}" name="smtp_user" value="{{ $gs->smtp_user }}" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" pattern="[^À-ž()/><\][\\\-;&$@!|]+" class="input-field" placeholder="{{ __('From Name') }}" name="from_name" value="{{ $gs->from_name }}" required>
          </div>
