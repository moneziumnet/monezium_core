      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.page.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="title" name="title"  placeholder="{{ __('Title') }}" value="" required>
            </div>
          ...
          <div class="showbox d-none">
            <div class="form-group">
              ...
              <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="meta_tag" name="meta_tag" placeholder="{{ __('Meta Tags') }}">
            </div>
