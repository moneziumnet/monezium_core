          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="amount" name="amount" placeholder="{{ __('Enter Amount') }}" min="0" value="" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="daily_send" name="daily_send" placeholder="{{ __('ex.1000') }}" min="0" value="" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="monthly_send" name="monthly_send" placeholder="{{ __('ex.10000') }}" min="0" value="" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="daily_receive" name="daily_receive" placeholder="{{ __('ex.1000') }}" min="0" value="" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="monthly_receive" name="monthly_receive" placeholder="{{ __('ex.10000') }}" min="0" value="" required>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="daily_withdraw" name="daily_withdraw" placeholder="{{ __('ex.1000') }}" min="0" value="" required>
              </div>
            </div>
