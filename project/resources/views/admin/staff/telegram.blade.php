...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Telegram Setting') }}</h5>
        <ol class="breadcrumb py-0 m-0">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin-staff-telegram') }}">{{ __('Staff Telegram') }}</a></li>
        </ol>
    </div>
</div>
  ...
  <div class="card mt-3 p-3">
    ...
    <form class="geniusform ms-2" action="{{ route('admin.staff.telegram.module.update', $data->id) }}" method="POST" enctype="multipart/form-data">
