...
@section('content')
	...
	<div class="card">
		<div class="d-sm-flex align-items-center justify-content-between">
			<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Crypto Currencies') }}</h5>
			<ol class="breadcrumb">
	...
	"use strict";
		var table = $('#geniustable').DataTable({
            ...
            $(".btn-area").append('<div class="col-sm-12 col-md-4 pr-3 text-right">'+
                '<a class="btn btn-primary" href="{{route('admin.crypto.currency.create')}}">'+
            '<i class="fas fa-plus"></i> {{__('Add New Crypto Currency')}}'+
            '</a>'+
            '</div>');
        });
