...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Dispute Details') }} <a href="{{route('admin.escrow.disputed')}}" class="btn btn-primary"><i class="fas fa-backward"></i> @lang('Back')</a></h5>
    </div>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.escrow.manage') }}">{{ __('Dispute Details') }}</a></li>
      </ol>
    </div>
  </div>
