      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.requestdomain.user.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inp-db_username" name="db_username" placeholder="{{ __('Enter Database Username') }}" value="" required>
          </div>

          <div class="form-group">
            <label for="inp-db_password">{{ __('Database Password') }}</label>
            <input type="text" class="form-control" id="inp-db_password" name="db_password" placeholder="{{ __('Enter Database Password') }}" value="">
          </div>
