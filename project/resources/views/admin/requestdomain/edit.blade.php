      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.requestdomain.user.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="inp-domains" name="domains" placeholder="{{ __('Enter domain name') }}" value="{{$data->domain_name}}" required>
          ...
          <div class="form-group">
            ...
            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="inp-db_name" name="db_name" placeholder="{{ __('Enter Database Name') }}" value="" required>
          </div>

          <div class="form-group">
            <label for="inp-db_username">{{ __('Database User') }}</label>
            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="inp-db_username" name="db_username" placeholder="{{ __('Enter Database Username') }}" value="" required>
          </div>
