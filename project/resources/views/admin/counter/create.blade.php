    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{route('admin.counter.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="input-field" name="title" placeholder="{{ __('Title') }}" required="" value="">
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-11">
            <div class="form-group">
              ...
              <input type="number"  class="input-field" name="count" placeholder="{{ __('Enter Value') }}" required="" value="">
            </div>
          </div>
        </div>
