      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="quick_title" name="quick_title"  placeholder="{{ __('Quick Title') }}" value="{{ $ps->quick_title }}" required>
            </div>

            <div class="form-group">
              <label for="quick_subtitle">{{ __('Quick Subtitle') }} *</label>
              <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="quick_subtitle" name="quick_subtitle"  placeholder="{{ __('Quick Title') }}" value="{{ $ps->quick_subtitle }}" required>
            </div>

            <div class="form-group">
                <label for="quick_link">{{ __('Quick Link') }} *</label>
                <input type="url" class="form-control" id="quick_link" name="quick_link"  placeholder="{{ __('Quick Link') }}" value="{{ $ps->quick_link }}" required>
            </div>
            ...
            <div class="form-group">
                <label>{{ __('Set Banner Image') }} <small class="small-font">({{ __('Preferred Size 1600 X 1100') }})</small></label>
                <div class="wrapper-image-preview">
                    <div class="box">
