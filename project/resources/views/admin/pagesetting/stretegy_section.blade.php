      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="strategy_title" name="strategy_title"  placeholder="{{ __('Strategy Title') }}" value="{{ $ps->strategy_title }}" required>
            </div>

            <div class="form-group">
              <label for="strategy_details">{{ __('Strategy Subtitle') }} *</label>
              <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="strategy_details" name="strategy_details"  placeholder="{{ __('Strategy Subtitle') }}" value="{{ $ps->strategy_details }}" required>
            </div>
