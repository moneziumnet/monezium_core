      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text"  pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="inp-title" name="app_title"  placeholder="{{ __('Enter Apps Title') }}" value="{{ $data->app_title }}" required>
            </div>
            ...
            <div class="form-group">
                <label for="app_store_link">{{  __('About Store Link')  }}</label>
                  <input type="text"  pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="app_store_link" name="app_store_link"  placeholder="{{ __('Enter About Link') }}" value="{{ $data->app_store_link }}" required>
                </div>
            </div>
