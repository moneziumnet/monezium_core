      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" pattern="[^À-ž()/><\][\\;$!|]+" class="form-control" id="service-title" name="service_title"  placeholder="{{ __('Service Title') }}" value="{{ $data->service_title }}" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" pattern="[^À-ž()/><\][\\;$!|]+" class="form-control" id="plan-title" name="plan_title"  placeholder="{{ __('Plan Title') }}" value="{{ $data->plan_title }}" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" pattern="[^À-ž()/><\][\\;$!|]+" class="form-control" id="review-title" name="review_title"  placeholder="{{ __('Testimonial Title') }}" value="{{ $data->review_title }}" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" pattern="[^À-ž()/><\][\\;$!|]+" class="form-control" id="blog-title" name="blog_title"  placeholder="{{ __('Blog Title') }}" value="{{ $data->blog_title }}" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" pattern="[^À-ž()/><\][\\;$!|]+" class="form-control" id="faq-title" name="faq_title"  placeholder="{{ __('FAQ Title') }}" value="{{ $data->faq_title }}" required>
            </div>
