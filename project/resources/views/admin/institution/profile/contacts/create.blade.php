...
<div class="card">
    <div class="d-sm-flex align-items-center justify-content-between py-3">
        <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Create New contact') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.institution.contacts',$data->id) }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
