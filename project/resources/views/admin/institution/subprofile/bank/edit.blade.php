          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="name" name="name" placeholder="{{ __('Enter Bank Name') }}" value="{{$data->name}}" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="address" name="address" placeholder="{{ __('Bank Address') }}" min="1" value="{{$data->address}}" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="min_limit" name="min_limit" placeholder="{{ __('0') }}" min="0" value="{{$data->min_limit}}" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" step="any" class="form-control" id="fixed_charge" name="fixed_charge" placeholder="{{ __('0') }}" min="0" value="{{$data->fixed_charge}}" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" step="any" class="form-control" id="percent_charge" name="percent_charge" placeholder="{{ __('0') }}" min="0" value="{{$data->percent_charge}}" required>
                  </div>
              </div>
            ...
            @foreach($bank_gateway->information as $key => $value)
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="{{$key}}" name="key[{{strval($key)}}]" placeholder="{{ __('Please input correct value') }}" value="{{$value}}" required>
                    </div>
                </div>
            @endforeach
          </div>
