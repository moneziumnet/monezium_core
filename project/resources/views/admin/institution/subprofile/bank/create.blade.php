          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="name" name="name" placeholder="{{ __('Enter Bank Name') }}" value="" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" class="form-control" id="address" name="address" placeholder="{{ __('Bank Address') }}"  value="" required>
                  </div>
              </div>
