...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between py-3">
    ...
    <ol class="breadcrumb py-0 m-0">
      ...
      <li class="breadcrumb-item"><a href="{{route('admin.institution.profile',$data->id)}}">{{ __('Profile') }}</a></li>
    </ol>
  </div>
</div>
      ...
      <form class="geniusform" action="{{route('admin.institution.moduleupdate',$data->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <div class="custom-control custom-switch">
                <input type="checkbox" name="section[]" value="Deposits" {{ $data->sectionCheck('Deposits') ? 'checked' : '' }} class="custom-control-input" id="management_deposit">
                <label class="custom-control-label" for="management_deposit">{{__('Deposits')}}</label>
              </div>
            </div>
          </div>
