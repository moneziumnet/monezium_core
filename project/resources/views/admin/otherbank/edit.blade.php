...
<div class="card">
  <div class="d-sm-flex align-items-center py-3 justify-content-between">
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit Bank') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.other.banks.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
...
<div class="col-md-10">
  <div class="card mb-4">
    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{route('admin.other.banks.update',$data->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"  pattern="[^À-ž()/><\][\\;&$@!|]+"  class="form-control" id="title" name="title" placeholder="{{ __('Enter Bank Name') }}" value="{{$data->title}}" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text"  pattern="[^À-ž()/><\][\\;&$@!|]+"  class="form-control" id="processing_time" name="processing_time" placeholder="{{ __('Enter Processing Time') }}" min="1" value="{{$data->processing_time}}" required>
                  </div>
              </div>
          </div>
          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="daily_maximum_limit" name="daily_maximum_limit" placeholder="{{ __('0') }}" min="1" value="{{$data->daily_maximum_limit}}" required>
                  </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="daily_total_transaction" name="daily_total_transaction" placeholder="{{ __('0') }}" min="1" value="{{$data->daily_total_transaction}}" required>
                  </div>
              </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="monthly_maximum_limit" name="monthly_maximum_limit" placeholder="{{ __('0') }}" min="1" value="{{$data->monthly_maximum_limit}}" required>
                </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="monthly_total_transaction" name="monthly_total_transaction" placeholder="{{ __('0') }}" min="1" value="{{$data->monthly_total_transaction}}" required>
                </div>
            </div>
         </div>
            ...
            @else
              @foreach ($informations as $key=>$info)
                <div class="lang-area mb-3">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <input type="text" pattern="[^À-ž()/><\][\\;&$@!|]+" name="form_builder[{{ $key }}][field_name]" class="form-control" placeholder="{{ __('Field Name') }}" value="{{ $info['field_name'] }}">
                    </div>
...
$("#lang-btn").on('click', function(){
    ...
    $("#lang-section").append(''+
            ...
            <div class="row">
              <div class="col-md-6">
                <input type="text"  pattern="[^À-ž()/><\\][\\\\;&$@!|]+"  name="form_builder[${id}][field_name]" class="form-control" placeholder="{{ __('Field Name') }}">
              </div>
...
$(document).on('click','.lang-remove', function(){
    ...
    if (isEmpty($('#lang-section'))) {
      ...
      $("#lang-section").append(''+
            ...
            <div class="row">
              <div class="col-md-6">
                <input type="text"  pattern="[^À-ž()/><\\][\\\\;&$@!|]+"  name="form_builder[1][field_name]" class="form-control" placeholder="{{ __('Field Name') }}">
              </div>
