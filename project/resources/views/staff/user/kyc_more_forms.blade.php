...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between py-3">
        ...
        <ol class="breadcrumb py-0 m-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('staff.user.kycinfo', $user->id) }}">{{ __('AML/KYC') }}</a></li>
        </ol>
	</div>
</div>
    ...
    <div class="card mb-4 mt-3">
        ...
        <div class="card-body">
            ...
            <form class="geniusform" action="{{route('staff.kyc.more.form.store')}}" method="POST" enctype="multipart/form-data">
