        ...
        <div class="tab-pane fade show active" id="modules" role="tabpanel" aria-labelledby="modules-tab">
            <div class="card-body">
                <div class="card mb-4">
                        ...
                        <div class="col-md-4 ml-3">
                            <div class="row">
                                ...
                                <div class="btn-group ml-5">
                                    ...
                                    <a class="dropdown-item drop-change" href="javascript:;" data-status="1" data-val="{{ __('Approved') }}" data-href="{{route('staff.user.kyc',['id1' => $data->id, 'id2' => 1])}}">{{ __('Approved') }}</a>
                                    <a class="dropdown-item drop-change" href="javascript:;" data-status="2" data-val="{{ __('Rejected') }}" data-href="{{route('staff.user.kyc',['id1' => $data->id, 'id2' => 2])}}">{{ __('Rejected') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <hr>
                    <div class="col-md-8">
                        <form action="{{route('staff.manage.kyc.add.more')}}" method="POST" enctype="multipart/form-data">
                            @csrf
      ...
      <script type="text/javascript">
          'use strict';
              ...
              var table = $('#geniustable1').DataTable({
                  ...
                  serverSide: true,
                  searching: false,
                  ajax: '{{ route('staff.user.more.kyc.datatables', $data->id) }}',
                  columns: [
              ...
              $(function() {
                  $("#geniustable1_wrapper .btn-area").append('<div class="col-sm-12 col-md-4 pr-3 text-right">'+
                      '<a class="btn btn-primary" href="{{route('staff.kyc.more.form.create', $data->id)}}">'+
