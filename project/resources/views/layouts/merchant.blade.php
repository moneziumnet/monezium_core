          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="{{getPhoto(merchant()->photo)}}" style="max-width: 60px">
                <span class="ml-2 d-none d-lg-inline text-white small">{{merchant()->name}}</span>
              </a>
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">

                <a class="dropdown-item" href="{{route('merchant.profile.setting')}}">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                    {{ __('Profile Setting') }}
                  </a>
                
                <a class="dropdown-item" href="{{route('merchant.change.password')}}">
                  <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                  {{ __('Change Password') }}
                </a>
                <a class="dropdown-item" href="{{route('merchant.two.step')}}">
                    <i class="fas fa-lock fa-sm fa-fw mr-2 text-gray-400"></i>
                    {{ __('Two Step Security') }}
                  </a>
                <a class="dropdown-item" href="{{route('merchant.ticket.index')}}">
