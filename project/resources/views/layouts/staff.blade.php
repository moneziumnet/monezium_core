          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="{{ Auth::guard('staff')->user()->photo ? asset('assets/images/'.Auth::guard('staff')->user()->photo ):asset('assets/user/img/user.jpg') }}" style="max-width: 60px">
