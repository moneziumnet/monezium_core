...
class SubscriptionController extends Controller
{
    public function store(Request $request){
        ...
        send_notification($user->id, ($user->company_name ?? $user->name).' Pricing Plan is updated.'."\n Plan Price : ".$plan->amount,$currency->code, route('admin-user-pricingplan', $user->id));
