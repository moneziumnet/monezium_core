...
class RequestMoneyController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
            ...
            ->editColumn('receiver_id', function(MoneyRequest $moeny_request){
                $data = User::whereId($moeny_request->receiver_id)->first();
                ...
                if($data){
                    ...
                    return '<div>
                            <span>'.$moeny_request->receiver_name.'</span>
                            <p>'.$moeny_request->receiver_email.'</p>
                    </div>';
                }
            })
