...
////////////////////////////// test mode end /////////////////////////////////////////////////////
    ...
    //     $user = auth()->user();
    //     $customer_bank = BankAccount::whereUserId($user->id)->where('subbank_id',$request->bank)->where('currency_id', $request->currency)->first();
    ...
    //         ],
    //     ]);
    //     $enduser = json_decode($response->getBody())->holder_id;
    //     $le
