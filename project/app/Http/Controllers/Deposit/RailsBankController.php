...
class RailsBankController extends Controller
{
    public function store(Request $request){
        ...
        if ($iban == null || $bic_swift == null) {
            return redirect()->back()->with(array('warning' => 'Sorry, You can not create New Bank Account succesfully because RailsBank\'s iban or swift is not generated by RailsBank API. Please try again.'));
        }
