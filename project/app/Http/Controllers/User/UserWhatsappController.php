                            ...
                            if (!$toWallet) {
                                if ($currency->type == 2) {
                                    if ($currency->code == 'BTC') {
                                        ...
                                        if (!$tron_wallet) {
                                            $to_message = 'Now, You do not have TRON Crypto Wallet. You have to create TRON Crypto wallet firstly for this exchange action .';
                                            $w_session->data = null;
                                            $w_session->save();
                                            send_message_whatsapp($to_message, $phone);
                                            return;
