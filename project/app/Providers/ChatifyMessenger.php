...
//        } else {
        $user->avatar = $user->photo ? asset('assets/images/' . $user->photo) : asset('assets/user/img/user.jpg');
//        }
        return $user;
    }
    ...
    {
        return asset("project/storage/10/app/public") . "/" . config('chatify.attachments.folder') . '/' . $attachment_name;
    }
}
